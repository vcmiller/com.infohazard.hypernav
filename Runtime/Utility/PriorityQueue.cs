...
// This file is edited by me (Vincent Miller) to work outside of recent .NET versions.
...
namespace HyperNav.Runtime.Utility {
    ...
    public class PriorityQueue<TElement, TPriority> {
        ...
        public PriorityQueue(int initialCapacity, IComparer<TPriority>? comparer) {
            if (initialCapacity < 0) {
                throw new ArgumentOutOfRangeException(
                    nameof(initialCapacity), initialCapacity, "Initial capacity < 0");
            }
        ...
        public int EnsureCapacity(int capacity) {
            if (capacity < 0) {
                throw new ArgumentOutOfRangeException(nameof(capacity), capacity, "Capacity < 0");
            }
        ...
        public sealed class UnorderedItemsCollection : IReadOnlyCollection<(TElement Element, TPriority Priority)>,
            ...
            void ICollection.CopyTo(Array array, int index) {
                ...
                if (array.GetLowerBound(0) != 0) {
                    throw new ArgumentException("Array must have zero as the lower bound", nameof(array));
                }

                if (index < 0 || index > array.Length) {
                    throw new ArgumentOutOfRangeException(nameof(index), index,
                                                          "Index out of range of the length of the array");
                }
                ...
                try {
                    ...
                    throw new ArgumentException("Array is an invalid type", nameof(array));
                }
            }
            ...
            public struct Enumerator : IEnumerator<(TElement Element, TPriority Priority)> {
                ...
                private bool MoveNextRare() {
                    if (_version != _queue._version) {
                        throw new InvalidOperationException("Concurrent iteration?");
                    }
